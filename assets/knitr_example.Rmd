...
author: "[Karl W Broman](https://kbroman.org)"
output: html_document
---

This is a portion of the "[A shorter tour of R/qtl](https://rqtl.org/rqtltour2.pdf)"
tutorial, developed here in multiple formats to illustrate the use of knitr.
This particular document is written with [R Markdown](https://rmarkdown.rstudio.com).
(Also see the [Markdown](http://daringfireball.net/projects/markdown/)
site.)

```{r knitr-options, include=FALSE}
knitr::opts_chunk$set(fig.width=12, fig.height=4, fig.path='RmdFigs/',
...
2002](https://www.ncbi.nlm.nih.gov/pubmed/12118100). Load the data into R/qtl as follows.
...
```{r plot-em-and-hk-alt, eval=FALSE}
